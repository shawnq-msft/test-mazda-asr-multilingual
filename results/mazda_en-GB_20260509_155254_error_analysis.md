...
| en-GB_DT1 | fast_mai_1 | 30 | 0.249 | 0.433 | 3.1 | 8.1 | 11.2 | 471 / 568 | 922 / 1059 |
| en-GB_DT1 | fast_mai_1.5 | 30 | 0.256 | 0.433 | 7.5 | 2.5 | 16.8 | 967 / 1020 | 1013 / 1081 |
...
| en-GB_DT2 | fast_mai_1 | 30 | 0.299 | 0.533 | 8.1 | 4.3 | 23.0 | 459 / 540 | 921 / 1092 |
| en-GB_DT2 | fast_mai_1.5 | 30 | 0.312 | 0.667 | 8.7 | 3.1 | 24.8 | 968 / 1035 | 1014 / 1088 |
...
| en-GB_DT3 | fast_mai_1 | 30 | 0.038 | 0.167 | 1.2 | 0.6 | 2.5 | 459 / 524 | 931 / 1101 |
| en-GB_DT3 | fast_mai_1.5 | 30 | 0.065 | 0.267 | 1.9 | 0.6 | 4.3 | 979 / 1082 | 1025 / 1144 |
...
| en-GB_DT4 | fast_mai_1 | 30 | 0.222 | 0.567 | 3.7 | 3.1 | 13.0 | 471 / 560 | 959 / 1098 |
| en-GB_DT4 | fast_mai_1.5 | 30 | 0.266 | 0.633 | 7.5 | 3.1 | 14.9 | 939 / 1014 | 985 / 1085 |
...
| en-GB_DT5 | fast_mai_1 | 30 | 0.038 | 0.167 | 1.2 | 0.6 | 2.5 | 470 / 582 | 944 / 1084 |
| en-GB_DT5 | fast_mai_1.5 | 30 | 0.081 | 0.233 | 2.5 | 0.6 | 5.0 | 933 / 985 | 979 / 1039 |
...
| en-GB_JT1 | fast_mai_1 | 30 | 0.060 | 0.200 | 1.9 | 0.6 | 3.1 | 474 / 562 | 923 / 1058 |
| en-GB_JT1 | fast_mai_1.5 | 30 | 0.076 | 0.233 | 2.5 | 0.6 | 3.7 | 967 / 1054 | 1013 / 1093 |
...
| en-GB_JT2 | fast_mai_1 | 30 | 0.097 | 0.333 | 1.9 | 1.9 | 5.6 | 470 / 533 | 953 / 1070 |
| en-GB_JT2 | fast_mai_1.5 | 30 | 0.101 | 0.300 | 3.1 | 1.2 | 5.0 | 932 / 1038 | 978 / 1075 |
...
| en-GB_JT3 | fast_mai_1 | 30 | 0.060 | 0.200 | 1.9 | 0.6 | 3.1 | 494 / 601 | 956 / 1142 |
| en-GB_JT3 | fast_mai_1.5 | 30 | 0.054 | 0.200 | 1.9 | 0.6 | 3.1 | 963 / 1076 | 1009 / 1087 |
...
| en-GB_JT4 | fast_mai_1 | 30 | 0.063 | 0.233 | 1.9 | 0.6 | 3.7 | 462 / 571 | 921 / 1045 |
| en-GB_JT4 | fast_mai_1.5 | 30 | 0.069 | 0.267 | 1.9 | 0.6 | 4.3 | 956 / 1066 | 1002 / 1106 |
...
|---|---|---|---|---:|---|---|
| [▶](audio/en-GB_DT2/2r_en-GB_male-DT2/higher%20volume%20please.wav.wav) | en-GB_DT2 | 2r_en-GB_male-DT2/higher volume please.wav | fast_mai_1 | 2.667 | `higher volume please` | `I will call you in a few minutes.` |
| [▶](audio/en-GB_DT1/1r_en-GB_female-DT1/Add%20Starbucks%20as%20a%20waypoint.wav.wav) | en-GB_DT1 | 1r_en-GB_female-DT1/Add Starbucks as a waypoint.wav | fast_mai_1.5 | 2.200 | `Add Starbucks as a waypoint` | `And it's still a bit, and to him he owns it.` |
...
| [▶](audio/en-GB_DT4/2r_en-GB_male-DT4/Open%20window.wav.wav) | en-GB_DT4 | 2r_en-GB_male-DT4/Open window.wav | fast_mai_1.5 | 2.000 | `Open window` | `I don't know.` |
...
| [▶](audio/en-GB_DT2/1r_en-GB_female-DT2/Enable%20automatic%20window%20closing%20when%20locking%20the%20car.wav.wav) | en-GB_DT2 | 1r_en-GB_female-DT2/Enable automatic window closing when locking the car.wav | fast_mai_1.5 | 1.625 | `Enable automatic window closing when locking the car` | `Today, though, Boston has a winter flight that has been left in the summer.` |
| [▶](audio/en-GB_DT2/2l_en-GB_female-DT2/delete%20this%20channel%20from%20favourites.wav.wav) | en-GB_DT2 | 2l_en-GB_female-DT2/delete this channel from favourites.wav | fast_mai_1.5 | 1.600 | `delete this channel from favourites` | `Please, let's turn on some fans up.` |
...
| [▶](audio/en-GB_DT2/1r_en-GB_female-DT2/Enable%20automatic%20window%20closing%20when%20locking%20the%20car.wav.wav) | en-GB_DT2 | 1r_en-GB_female-DT2/Enable automatic window closing when locking the car.wav | fast_mai_1 | 1.250 | `Enable automatic window closing when locking the car` | `Then I do 1st mark the winter's light there.` |
...
- fast_mai_1     `Unmute the media.`
- fast_mai_1.5   `Unmute the media.`
...
- fast_mai_1     `Enable Android Auto.`
- fast_mai_1.5   `Enable Android Auto.`
...
- fast_mai_1     `Higher volume, please.`
- fast_mai_1.5   `Higher volume, please.`
...
- fast_mai_1     `Turn off rear fog lamp.`
- fast_mai_1.5   `Turn off Maria Fogline.`
...
- fast_mai_1     `Have fun and have a great holiday.`
- fast_mai_1.5   `At the other end of the waypoint.`
...
- fast_mai_1     `Fold in rear view mirrors.`
- fast_mai_1.5   `Fold in rear view mirror.`
...
- fast_mai_1     `Switch the braking mode to standard.`
- fast_mai_1.5   `Switch the briefing mode to standard.`
...
- fast_mai_1     `Lower driver's seat ventilation and theaters.`
- fast_mai_1.5   `Lower driver's seat ventilation and seat levers.`
...
- fast_mai_1     `Fold in rear view mirrors.`
- fast_mai_1.5   `Fold in rear view mirrors.`
...
- fast_mai_1     `Make the map smaller.`
- fast_mai_1.5   `Make the maps smaller.`
