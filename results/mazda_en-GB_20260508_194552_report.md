# Mazda ASR Benchmark — mazda_en-GB_20260508_194552.csv
...
TCP ping to `eastus.api.cognitive.microsoft.com:443` (avg of 5): **248.3 ms**  
...
|---|---|---:|---:|---:|---:|---:|---:|---:|---|---|---|
| en-GB_DT1 | fast_default | 30 | 0 | 0.260 | 0.433 | 3.8 | 5.6 | 12.5 | - | 555 / 630 | 997 / 1169 |
| en-GB_DT1 | fast_llm | 30 | 0 | 0.220 | 0.367 | 4.4 | 5.0 | 8.8 | - | 476 / 498 | 918 / 1055 |
| en-GB_DT1 | fast_mai | 30 | 0 | 0.200 | 0.367 | 4.4 | 2.5 | 10.6 | - | 522 / 630 | 964 / 1171 |
| en-GB_DT1 | realtime | 30 | 0 | 0.241 | 0.500 | 2.5 | 3.8 | 13.8 | 1475 / 1859 | -303 / 328 | 619 / 831 |
| en-GB_DT1 | realtime_refine | 30 | 0 | 0.246 | 0.467 | 4.4 | 3.1 | 13.8 | 1590 / 2430 | 65 / 736 | 1126 / 1292 |
| en-GB_DT2 | fast_default | 30 | 0 | 0.356 | 0.567 | 3.1 | 12.5 | 20.0 | - | 594 / 652 | 1090 / 1221 |
| en-GB_DT2 | fast_llm | 30 | 0 | 0.273 | 0.500 | 1.9 | 8.1 | 16.9 | - | 476 / 530 | 974 / 1130 |
| en-GB_DT2 | fast_mai | 30 | 0 | 0.261 | 0.400 | 4.4 | 2.5 | 17.5 | - | 482 / 588 | 908 / 1120 |
| en-GB_DT2 | realtime | 30 | 0 | 0.351 | 0.600 | 5.0 | 11.9 | 16.9 | 1454 / 1893 | -300 / 327 | 617 / 951 |
| en-GB_DT2 | realtime_refine | 30 | 0 | 0.382 | 0.600 | 5.0 | 6.2 | 25.6 | 1482 / 1875 | 125 / 657 | 1243 / 1691 |
| en-GB_JT1 | fast_default | 30 | 0 | 0.086 | 0.200 | 2.5 | 3.1 | 1.9 | - | 603 / 768 | 1011 / 1305 |
| en-GB_JT1 | fast_llm | 30 | 0 | 0.080 | 0.200 | 1.9 | 3.8 | 1.2 | - | 474 / 516 | 882 / 1058 |
| en-GB_JT1 | fast_mai | 30 | 0 | 0.104 | 0.233 | 2.5 | 3.8 | 3.1 | - | 496 / 626 | 904 / 1062 |
| en-GB_JT1 | realtime | 30 | 0 | 0.135 | 0.300 | 2.5 | 3.1 | 5.0 | 1374 / 1798 | -248 / 328 | 614 / 911 |
| en-GB_JT1 | realtime_refine | 30 | 0 | 0.138 | 0.267 | 4.4 | 2.5 | 3.8 | 1429 / 1850 | 102 / 721 | 1112 / 1320 |

## Speech boundaries

`speech_start_s` / `speech_end_s` (CSV columns) come from the realtime SDK's word-level timestamps and anchor UPL for all services. The full per-word log lives in the sidecar `mazda_en-GB_20260508_194552_words.jsonl` (one JSON object per realtime sample).
